...
the [course schedule](../schedule/index.qmd). After either an unexcused absence
or a late attendance to either a class or a laboratory session, a student's
weekly class participation grade will be reduced. Students who need to miss
...
student's weekly class participation grade will be reduced if they are observed
undertaking non-course-related activities like viewing email, social media, or
other content not about algorithm analysis. 
...
prior arrangements are made with the course instructor, all students should use
...
[course schedule](../schedule/index.qmd). During the completion of a *scientific
study* in the field of algorithm analysis, students will complete and present a
team-based project in which they propose and then answer a research question
about the performance of a Python program. When completing an *engineering
effort* in the field of algorithm analysis, students will build and present a
team-based project in which they design, implement, document, release, and
maintain a software tool that supports the rigorous evaluation of the
...
positively influence the lives of many people. At the start of this class, I
invite you to join together in an adventure in algorithm analysis!
...
bound by the rules in this syllabus, they can rely on the
